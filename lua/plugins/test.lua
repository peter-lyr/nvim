return {
  ...
  -- startuptime
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_user_command('STARTUPTIME', function(params)
        require 'base'.cmd('StartupTime %s', vim.fn.join(params.fargs, ' '))
  ...
  -- hop
  {
    'phaazon/hop.nvim',
    keys = {
      { 'f', ':HopChar1<cr>', mode = { 'n', }, silent = true, desc = 'HopChar1', },
      { 's', ':HopChar2<cr>', mode = { 'n', }, silent = true, desc = 'HopChar2', },
    },
    config = function()
      require 'hop'.setup {
