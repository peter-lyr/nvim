...
B.lazy_map {
  ...
  { '<leader>w<leader>', '<c-w>p',                                     mode = { 'n', 'v', }, desc = 'my.window: go toggle last window', },
  ...
  { '<leader>x<c-r>',    function() M.listed_cur_root_files 'all' end, mode = { 'n', 'v', }, desc = 'my.window: listed_cur_root_files all', },
