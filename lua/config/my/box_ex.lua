...
r {
  ...
  ['<F9><a-e>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to e', mode = { 'n', }, silent = true, },
  ['<F9><a-f>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to f', mode = { 'n', }, silent = true, },
  ['<F9><a-g>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to g', mode = { 'n', }, silent = true, },
  ['<F9><a-h>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to h', mode = { 'n', }, silent = true, },
  ['<F9><a-i>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to i', mode = { 'n', }, silent = true, },
  ['<F9><a-j>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to j', mode = { 'n', }, silent = true, },
  ['<F9><a-k>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to k', mode = { 'n', }, silent = true, },
  ['<F9><a-l>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to l', mode = { 'n', }, silent = true, },
  ['<F9><a-m>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to m', mode = { 'n', }, silent = true, },
  ['<F9><a-n>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to n', mode = { 'n', }, silent = true, },
  ['<F9><a-o>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to o', mode = { 'n', }, silent = true, },
  ['<F9><a-p>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to p', mode = { 'n', }, silent = true, },
  ['<F9><a-q>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to q', mode = { 'n', }, silent = true, },
  ['<F9><a-r>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to r', mode = { 'n', }, silent = true, },
  ['<F9><a-s>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to s', mode = { 'n', }, silent = true, },
  ['<F9><a-t>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to t', mode = { 'n', }, silent = true, },
  ['<F9><a-u>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to u', mode = { 'n', }, silent = true, },
  ['<F9><a-v>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to v', mode = { 'n', }, silent = true, },
  ['<F9><a-w>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to w', mode = { 'n', }, silent = true, },
  ['<F9><a-x>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to x', mode = { 'n', }, silent = true, },
  ['<F9><a-y>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to y', mode = { 'n', }, silent = true, },
  ['<F9><a-z>'] = { function() require 'config.my.box'.yank('d', 'n', 'W') end, 'my.box.yank: <cWORD> to z', mode = { 'n', }, silent = true, },
}
